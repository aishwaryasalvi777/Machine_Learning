...
def create_multilayer_perceptron():
    ...
    class net(nn.Module):
        def __init__(self):
            ...
            n_hidden_3 = 256  # 3rd layer number of features (new layer) ## me 
            ...
            self.layer_3 = nn.Linear(n_hidden_2, n_hidden_3)  # New layer  ## me 
        ...
        def forward(self, x):
            ...
            x = F.relu(self.layer_3(x))  # Activation for 3rd hidden layer  ## me
            x = self.out_layer(x)
            return x
